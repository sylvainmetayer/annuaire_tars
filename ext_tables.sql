#
# Table structure for table 'tx_annuairetars_domain_model_contact'
#
CREATE TABLE tx_annuairetars_domain_model_contact (
...
#
# Table structure for table 'tx_annuairetars_domain_model_organisme'
#
CREATE TABLE tx_annuairetars_domain_model_organisme (
	...
	horaires varchar(255) DEFAULT '' NOT NULL,
...
#
# Table structure for table 'tx_annuairetars_domain_model_fonction'
#
CREATE TABLE tx_annuairetars_domain_model_fonction (
...
#
# Table structure for table 'tx_annuairetars_domain_model_service'
#
CREATE TABLE tx_annuairetars_domain_model_service (
